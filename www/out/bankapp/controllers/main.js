...
var G__10613 = {};
(G__10613["getbanksbytype"] = ((function (G__10613){
return (function (type){
return $http.post([cljs.core.str(bankapp.controllers.main.serverurl),cljs.core.str("getbanksbytype")].join(''),(((type == null))?null:(function (){var G__10617 = {};
(G__10617["type"] = type);

return G__10617;
})())).then(((function (G__10613){
...
var o_SHARP__10623 = $scope;
(o_SHARP__10623["loginData"] = cljs.core.PersistentArrayMap.EMPTY);
...
var o_SHARP__10624 = $scope;
(o_SHARP__10624["getbanks"] = ((function (o_SHARP__10624){
return (function (type){
cljs.core.println.call(null,"1212122");

return MapService.getbanksbytype(type).then(((function (o_SHARP__10624){
return (function (response){
cljs.core.println.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,bankapp.controllers.main.global_hub),"markers"));

if(cljs.core.empty_QMARK_.call(null,(response["data"]))){
return cljs.core.dorun.call(null,cljs.core.map.call(null,((function (o_SHARP__10624){
return (function (p1__10621_SHARP_){
return cljs.core.get.call(null,cljs.core.deref.call(null,bankapp.controllers.main.global_hub),"map").removeLayer(p1__10621_SHARP_);
});})(o_SHARP__10624))
...
return bankapp.controllers.main.makemark.call(null,p1__10622_SHARP_);
});})(o_SHARP__10624))
,(response["data"])));
}
});})(o_SHARP__10624))
...
var o_SHARP__10625 = $scope;
(o_SHARP__10625["closeLogin"] = ((function (o_SHARP__10625){
return (function (){
...
var o_SHARP__10626 = $scope;
(o_SHARP__10626["login"] = ((function (o_SHARP__10626){
return (function (){
...
return fn_SHARP_.call(obj_SHARP_,"map",(function (){var G__10627 = {};
(G__10627["zoomControl"] = false);
...
return fn_SHARP_.call(obj_SHARP_,"http://t{s}.tianditu.cn/vec_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=vec&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}",(function (){var G__10631 = {};
(G__10631["subdomains"] = "012345");
...
var fn_SHARP_ = (obj_SHARP_["tileLayer"]);
return fn_SHARP_.call(obj_SHARP_,[cljs.core.str("http://t{s}.tianditu.com/cva_w/wmts?"),cljs.core.str("SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cva&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles"),cljs.core.str("&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}")].join(''),(function (){var G__10635 = {};
(G__10635["subdomains"] = "012345");
...
var redMarker = L.AwesomeMarkers.icon((function (){var G__10651 = {};
(G__10651["iconColor"] = "black");

(G__10651["icon"] = "location");

(G__10651["prefix"] = "ion");

return G__10651;
})());
cljs.core.swap_BANG_.call(null,bankapp.controllers.main.global_hub,cljs.core.assoc,"markers",cljs.core.conj.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,bankapp.controllers.main.global_hub),"markers"),redMarker));

return L.marker(item.loc.coordinates,(function (){var G__10655 = {};
(G__10655["icon"] = (function (){var obj_SHARP_ = (L["AwesomeMarkers"]);
var fn_SHARP_ = (obj_SHARP_["icon"]);
return fn_SHARP_.call(obj_SHARP_,(function (){var G__10659 = {};
(G__10659["icon"] = "location");
